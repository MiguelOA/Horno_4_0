...
//* Version: 0.40 alpha (completo sin salidas de conmsola)
//* Fecha: Mayo 2020
...
// NOTAS:
// 1.- La salida de las lecturas digitales es ENC y APG en el rango
//     indicado en la base de datos (poner esto en el manual).
